...
const C = {
  // Core palette — mirrors the Orders page sky→green gradient
  skyBlue: '#87ceeb',
  skyMid: '#5bafd6',
  green: '#7cb342',
  darkGreen: '#4a8a1a',
  ...
  // Accents — yellow/orange kept for active state so brand stays consistent
  yellow: '#ffe135',
  orange: '#ff8c00',
  brownDarker: '#4a2511',
  ...
  return (
    ...
    >
      ...
      <nav style={{ flex: 1, padding: '14px 10px', overflowY: 'auto' }}>
        ...
        {/* Franchise Owner: Create Account */}
